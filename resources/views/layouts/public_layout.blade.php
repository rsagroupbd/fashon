...
<head>
	...
	<!-- Favicon-->
	<link rel="shortcut icon" href="{{URL::to('theme/img/fav.png')}}">
	<!-- Author Meta -->
		...
		<div class="main_menu">
			<nav class="navbar navbar-expand-lg navbar-light main_box">
				<div class="container">
					...
					<a class="navbar-brand logo_h" href="{{route('home')}}"><img src="{{URL::to('theme/img/logo.png')}}" alt=""></a>
				...
				<div class="col-lg-3  col-md-6 col-sm-6">
					<div class="single-footer-widget mail-chimp">
						...
						<ul class="instafeed d-flex flex-wrap">
							<li><img src="{{URL::to('theme/img/i1.jpg')}}" alt=""></URL::toli>
							<li><img src="{{URL::to('theme/img/i2.jpg')}}" alt=""></li>
							<li><img src="{{URL::to('theme/img/i3.jpg')}}" alt=""></li>
							<li><img src="{{URL::to('theme/img/i4.jpg')}}" alt=""></li>
							<li><img src="{{URL::to('theme/img/i5.jpg')}}" alt=""></li>
							<li><img src="{{URL::to('theme/img/i6.jpg')}}" alt=""></li>
							<li><img src="{{URL::to('theme/img/i7.jpg')}}" alt=""></li>
							<li><img src="{{URL::to('theme/img/i8.jpg')}}" alt=""></li>
						</ul>
					</div>
				</div>
...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
	...
	<!--gmaps Js-->
	<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCjCGmQ0Uq4exrzassetdcL6rvxywDDOvfAu6eE"></script>
